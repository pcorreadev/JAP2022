...
let searchResult = initialArray.products.filter(initialArray => {
     return (initialArray.name.toLowerCase().indexOf(inputBuscar.toLowerCase()) > -1 && initialArray.description.toLowerCase().indexOf(inputBuscar.toLowerCase()) > -1);
    })
